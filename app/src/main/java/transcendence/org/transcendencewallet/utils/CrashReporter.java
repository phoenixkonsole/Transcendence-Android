...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final TranscendenceApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (TranscendenceContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + TranscendenceContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((TranscendenceModuleImp)application.getModule()).getWallet();
