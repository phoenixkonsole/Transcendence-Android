package transcendence.org.transcendencewallet.ui.import_watch_only;
...
import static transcendence.org.transcendencewallet.utils.CrashReporter.appendSavedBackgroundTraces;
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                transcendenceModule.watchOnlyMode(
                        xpub,
