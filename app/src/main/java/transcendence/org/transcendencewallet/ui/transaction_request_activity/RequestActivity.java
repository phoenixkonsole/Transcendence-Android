package transcendence.org.transcendencewallet.ui.transaction_request_activity;
...
import transcendence.org.transcendencewallet.ui.transaction_send_activity.AmountInputFragment;
...
import static transcendence.org.transcendencewallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static transcendence.org.transcendencewallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = transcendenceModule.getFreshNewAddress().toBase58();

        NetworkParameters params = transcendenceModule.getConf().getNetworkParams();

        String transcendenceURI = SendURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(transcendenceURI);
        qrDialog.setQrText(transcendenceURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String transcendenceURI) throws WriterException {
