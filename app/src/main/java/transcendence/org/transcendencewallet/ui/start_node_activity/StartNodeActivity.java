package transcendence.org.transcendencewallet.ui.start_node_activity;
...
import transcendence.org.transcendencewallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                transcendenceApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = transcendenceApplication.getAppConf().getTrustedNode()!=null;
                transcendenceApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = transcendenceApplication.getAppConf().getTrustedNode();
