package transcendence.org.transcendencewallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = transcendenceModule.backupWallet(backupFile, firstPassword);

            if (result){
                transcendenceApplication.getAppConf().setHasBackup(true);
