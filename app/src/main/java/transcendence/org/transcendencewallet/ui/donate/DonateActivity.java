package transcendence.org.transcendencewallet.ui.donate;
...
import org.transcendencej.core.MasterNodeSystem;
import org.transcendencej.core.MasternodeInfo;
import org.transcendencej.core.MasternodeManager;
...
public class DonateActivity extends BaseDrawerActivity {
    ...
    private void send() {
        try {
            // create the tx
            String addressStr = TranscendenceContext.DONATE_ADDRESS;
            ...
            Transaction transaction = transcendenceModule.buildSendTx(addressStr, amount, memo,transcendenceModule.getReceiveAddress());
            // send it
            transcendenceModule.commitTx(transaction);
            Intent intent = new Intent(DonateActivity.this, TranscendenceWalletService.class);
