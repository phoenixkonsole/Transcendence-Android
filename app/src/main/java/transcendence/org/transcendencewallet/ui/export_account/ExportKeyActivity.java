package transcendence.org.transcendencewallet.ui.export_account;
...
import transcendence.org.transcendencewallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = transcendenceModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(TranscendenceContext.NETWORK_PARAMETERS);
