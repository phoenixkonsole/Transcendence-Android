package transcendence.org.transcendencewallet.ui.words_restore_activity;
...
import transcendence.org.transcendencewallet.ui.transaction_send_activity.MyFilterableAdapter;
import transcendence.org.transcendencewallet.ui.transaction_send_activity.MyTextWatcher;
...
import static transcendence.org.transcendencewallet.module.TranscendenceContext.Transcendence_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = transcendenceModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            transcendenceModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            transcendenceModule.restoreWallet(mnemonic, Transcendence_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (transcendenceApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!transcendenceApplication.getAppConf().isAppInit()){
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, TranscendenceContext.ENABLE_BIP44_APP_VERSION));
