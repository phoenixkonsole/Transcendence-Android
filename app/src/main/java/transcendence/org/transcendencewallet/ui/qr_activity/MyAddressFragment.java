...
import static transcendence.org.transcendencewallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    private TranscendenceModule module;
    ...
    public static MyAddressFragment newInstance(TranscendenceModule transcendenceModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(transcendenceModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = TranscendenceApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String transcendenceUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(transcendenceUri,address.toBase58());
            }
    ...
    public void setModule(TranscendenceModule module) {
        this.module = module;
    }
