...
public class CoinMarketCapApiClient {
    ...
    public class TranscendenceMarket{
        ...
        public TranscendenceMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public TranscendenceMarket getTranscendencePxrice() throws RequestTranscendenceRateException{
        try {
            TranscendenceMarket pivxMarket = null;
            String url = this.URL + "ticker/transcendence/";
            ...
            if (httpResponse.getStatusLine().getStatusCode()==200){
                ...
                pivxMarket = new TranscendenceMarket(
            ...
            e.printStackTrace();
            throw new RequestTranscendenceRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestTranscendenceRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestTranscendenceRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestTranscendenceRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
