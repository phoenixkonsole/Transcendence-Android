...
public class CoinMarketCapApiClient {
    ...
    public class AirWireMarket{
        ...
        public AirWireMarket(BigDecimal priceUsd, BigDecimal priceBtc, BigDecimal marketCapUsd, BigDecimal totalSupply, int rank) {
    ...
    public AirWireMarket getAirWirePxrice() throws RequestAirWireRateException{
        try {
            AirWireMarket pivxMarket = null;
            String url = this.URL + "ticker/airwire/";
            ...
            e.printStackTrace();
            throw new RequestAirWireRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestAirWireRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestAirWireRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestAirWireRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
