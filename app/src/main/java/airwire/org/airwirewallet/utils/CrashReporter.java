...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final AirWireApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (AirWireContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + AirWireContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((AirWireModuleImp)application.getModule()).getWallet();
