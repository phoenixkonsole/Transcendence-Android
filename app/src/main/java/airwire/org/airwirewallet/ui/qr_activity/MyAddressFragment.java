...
import static airwire.org.airwirewallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(AirWireModule airwireModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(airwireModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = AirWireApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String airwireUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(airwireUri,address.toBase58());
            }
    ...
    public void setModule(AirWireModule module) {
        this.module = module;
    }
