package airwire.org.airwirewallet.ui.start_node_activity;
...
import airwire.org.airwirewallet.ui.pincode_activity.PincodeActivity;
import airwire.org.airwirewallet.ui.wallet_activity.WalletActivity;
import airwire.org.airwirewallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                airwireApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = airwireApplication.getAppConf().getTrustedNode()!=null;
                airwireApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = airwireApplication.getAppConf().getTrustedNode();
