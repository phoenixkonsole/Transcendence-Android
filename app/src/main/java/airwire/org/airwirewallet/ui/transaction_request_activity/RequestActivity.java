package airwire.org.airwirewallet.ui.transaction_request_activity;
...
import airwire.org.airwirewallet.ui.transaction_send_activity.AmountInputFragment;
import airwire.org.airwirewallet.utils.DialogsUtil;
import airwire.org.airwirewallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static airwire.org.airwirewallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static airwire.org.airwirewallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = airwireModule.getFreshNewAddress().toBase58();

        NetworkParameters params = airwireModule.getConf().getNetworkParams();

        String airwireURI = SendURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(airwireURI);
        qrDialog.setQrText(airwireURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String airwireURI) throws WriterException {
