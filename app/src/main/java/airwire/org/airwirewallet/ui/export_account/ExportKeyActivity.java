package airwire.org.airwirewallet.ui.export_account;
...
import airwire.org.airwirewallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = airwireModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(AirWireContext.NETWORK_PARAMETERS);
