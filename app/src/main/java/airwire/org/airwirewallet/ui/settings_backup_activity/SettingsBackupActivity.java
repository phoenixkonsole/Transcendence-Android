package airwire.org.airwirewallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = airwireModule.backupWallet(backupFile, firstPassword);

            if (result){
                airwireApplication.getAppConf().setHasBackup(true);
