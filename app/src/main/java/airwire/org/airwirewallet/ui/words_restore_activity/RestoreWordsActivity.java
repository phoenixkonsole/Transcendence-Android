package airwire.org.airwirewallet.ui.words_restore_activity;
...
import airwire.org.airwirewallet.ui.transaction_send_activity.MyFilterableAdapter;
import airwire.org.airwirewallet.ui.transaction_send_activity.MyTextWatcher;
...
import static airwire.org.airwirewallet.module.AirWireContext.AirWire_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = airwireModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            airwireModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            airwireModule.restoreWallet(mnemonic, AirWire_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (airwireApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!airwireApplication.getAppConf().isAppInit()){
                                                            airwireApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, AirWireContext.ENABLE_BIP44_APP_VERSION));
